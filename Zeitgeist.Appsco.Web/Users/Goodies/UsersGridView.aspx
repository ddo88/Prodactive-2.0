        ...
        <asp:GridView ID="UsersGridView" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <div class="useruserGridRoll">
                        <a href='../Admin/edit_user.aspx?useruser=<%# Eval("UserName") %>' title="click for details"><%# Eval("UserName") %></a>
                        </div>
                    </ItemTemplate>
                </asp:TemplateField>          
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="User Name">
                    ...
                    <ItemTemplate>
                        <a href='../admin/edit_user_modal.aspx?useruser=<%# Eval("UserName") %>' rel="gb_page_center[525, 600]" title="click for details"><%# Eval("UserName") %></a>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Email">
                    <EditItemTemplate>
