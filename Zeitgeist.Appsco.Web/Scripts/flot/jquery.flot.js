...
(function($) {
	...
	Canvas.prototype.resize = function(width, height) {
	    try {
	        ...
	        // SaveClient the context, so we can reset in case we get replotted.  The
